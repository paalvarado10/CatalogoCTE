...
class HerramientaModelCase(TestCase):
    def setUp(self):
        Herramienta.objects.create(version="Version Prueba", nombre="prueba", urlReferencia="www.google.com", sistemaOperativo="Windows", plataforma="Plataforma Prueba", fichaTecnica="Ficha tecnica prueba", descripcion="desc", licencia="gratis", estado=1, logo="logo", revisor1=1,revisor2=2,autor=0)
...
class ActividadModelCase(TestCase):
    def setUp(self):
        ...
        Actividad.objects.create(herramienta=herramienta, version="Version Prueba", nombre="actividadprueba", descripcion="descActividad", instrucciones="instruccionesPrueba", url="www.actividad.com", estado=1, revisor1=1, revisor2=2, autor=0)
...
class TutorialModelCase(TestCase):
    def setUp(self):
        Herramienta.objects.create(version="Version Prueba", nombre="prueba", urlReferencia="www.google.com", sistemaOperativo="Windows", plataforma="Plataforma Prueba",fichaTecnica="Ficha tecnica prueba", descripcion="desc", licencia="gratis", estado=1, revisor1=1, revisor2=2, autor=0, logo="logo")
        herramienta = Herramienta.objects.get(nombre='prueba')
        Tutorial.objects.create(herramienta=herramienta, version="Version Prueba", nombre="tutorialPrueba", funcionalidad="funcionalidadTutorial", estado=1, revisor1=1, revisor2=2, autor=0)
